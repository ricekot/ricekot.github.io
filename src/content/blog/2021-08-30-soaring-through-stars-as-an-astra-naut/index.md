...
<figure class="mx-auto my-8 max-w-3xl w-3/4">
  <img
    src="/assets/images/astra-naut-stars.png"
    alt="A cartoon astronaut is sitting on a rocket with the Astra logo on it. The background is filled with stars as the astronaut is flying through space."
  ...
  <figcaption class="mt-3 text-sm text-gray-500 dark:text-gray-400">
    <details style="font-size:12px">
      ...
      <table>
        ...
        <tr><td>4.</td><td>Edited by me.</td></tr>
      </table>
    </details>
  </figcaption>
</figure>
...
<figure class="mx-auto my-8 max-w-3xl text-center w-full">
  <img
    src="/assets/images/astra-scanner.png"
    alt="A software diagram with four components - the scanner microservice, the Chowkidar ZAP add-on, the Scanner Rules ZAP add-on and the frontend. Chowkidar sits between the scanner service and the frontend. The Scanner Rules add-on is a branch to the side."
    class="mx-auto rounded-lg shadow-md"
  />
  <figcaption class="mt-3 text-sm text-gray-500 dark:text-gray-400">
...
<figure class="mx-auto my-8 max-w-3xl text-center w-full">
  <img
    src="/assets/images/astra-notebook.jpg"
    alt='A notebook with a cartoon astronaut holding a laptop and the following words on the cover: "Happiness is... being an Astra-naut!"'
    class="mx-auto rounded-lg shadow-md"
  />
</figure>
