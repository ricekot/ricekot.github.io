...
Note: This blog post was originally published on the [Levo blog](https://web.archive.org/web/20240412132742/https://www.levo.ai/post/getting-kubernetes-metadata-on-linux-nodes).
...
<figure class="mx-auto my-8 max-w-3xl text-center">
	<img
		src="/assets/images/levo-dashboard-k8s-context.png"
		alt="Kubernetes context for an endpoint in the Levo dashboard"
