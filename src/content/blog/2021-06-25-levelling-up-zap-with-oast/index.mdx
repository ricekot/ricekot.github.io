...
description: "Introducing the OAST add-on for OWASP ZAP, bringing out-of-band security testing capabilities like blind SQLi detection to the proxy."
date: "Jun 25 2021"
# category: zap-oast
# tags: notes zap
---
...
<Figure
  src="/assets/images/zap-oast-graphic.png"
  alt="ZAP OAST Graphic that has logos of ZAP, the target and OAST with arrows between them."
  caption="ZAP and OAST"
  shadow={false}
/>
...
<Figure
  src="/assets/images/zap-oast-options.png"
  alt="ZAP OAST Options Window"
  caption="ZAP OAST Options (Preview)"
/>
...
<Figure 
  src="/assets/images/zap-oast-blind-sqli.png"
  alt="ZAP OAST Graphic that shows an example of a blind SQL injection payload."
  caption="An example of Blind SQLi with ZAP and OAST"
  shadow={false}
/>
