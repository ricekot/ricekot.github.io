...
description: "Step-by-step notes on implementing gradient descent for linear regression in PyTorch, with code and visualizations."
date: "Jul 14 2019"
---
...
Also check out my [last post](/2019/holdups-gradient-descent) for some info on ```requires_grad``` and autograd.
