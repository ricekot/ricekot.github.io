...
Fast forward to high school, I [discovered an authentication bypass vulnerability](/2018/i-found-a-bug) in my coaching institute's website. I wrote an exploit for the bug in Python with a browser-automation tool called [Selenium](https://www.selenium.dev/), a member project of the [Software Freedom Conservancy](https://sfconservancy.org/).

I fooled around with lots of free tools in college - e.g. this blog is built with Jekyll, I used OpenJDK and Gradle when I [started contributing to ZAP](/2020/beginning-my-security-journey), etc.
